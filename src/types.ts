...
export interface Batch {
  ...
  quotas: Quota[];
  issues: Issue[];
  tools: { id: string; thread: string; turn: string; kind: string; at: string }[];
}
export function emptyBatch(): Batch {
  return { threads: [], turns: [], samples: [], quotas: [], issues: [], tools: [] };
}
